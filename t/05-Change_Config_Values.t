...
sub change_each_config_parameter{
   ...
   #my $current_config = $cam_interface->configuration();
   my $current_config;
   #my $current_config = $cam_interface;
   ...
   $cam_interface->change_preview_res('01');
   #$current_config->{preview_resolution} = '01';
   push(@{$config_array_expected}, dclone($cam_interface->commandset->configuration()));
